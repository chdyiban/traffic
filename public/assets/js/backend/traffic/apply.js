define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'traffic/apply/index' + location.search,
                    add_url: 'traffic/apply/add',
                    edit_url: 'traffic/apply/edit',
                    del_url: 'traffic/apply/del',
                    multi_url: 'traffic/apply/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        buttons: [
							{name: 'detail', text:"查看详情",classname: 'btn btn-xs btn-primary btn-success btn-detail  btn-dialog', url: 'traffic/apply/detail', callback: function (data){}},      
						],  
